...
将编译好的文件 enc.so 加入到配置项 extension=enc.so，重启 PHP 服务
...
eg:
# php7.4 64位 非线程安全版
php_enc-1.0.0-7.4-nts-vc15-x64.dll
# php7.4 32位 非线程安全版
php_enc-1.0.0-7.4-nts-vc15-x86.dll
# php7.4 64位 线程安全版
php_enc-1.0.0-7.4-ts-vc15-x64.dll
# php7.4 32位 线程安全版
php_enc-1.0.0-7.4-ts-vc15-x86.dll
