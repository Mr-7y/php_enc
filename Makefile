...
top_builddir = /workspace
EGREP = /usr/bin/grep -E
SED = /usr/bin/sed
AWK = gawk
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
shared_objects_enc = enc.lo
PHP_PECL_EXTENSION = enc
PHP_MODULES = $(phplibdir)/enc.la
PHP_ZEND_EX =
all_targets = $(PHP_MODULES) $(PHP_ZEND_EX)
install_targets = install-modules install-headers
prefix = /root/.phpenv/versions/8.5snapshot
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
phpincludedir = /root/.phpenv/versions/8.5snapshot/include/php
CC = cc
CFLAGS = -g -O2
...
EXTENSION_DIR = /root/.phpenv/versions/8.5snapshot/lib/php/extensions/no-debug-non-zts-20250925
PHP_EXECUTABLE = /root/.phpenv/versions/8.5snapshot/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/root/.phpenv/versions/8.5snapshot/include/php -I/root/.phpenv/versions/8.5snapshot/include/php/main -I/root/.phpenv/versions/8.5snapshot/include/php/TSRM -I/root/.phpenv/versions/8.5snapshot/include/php/Zend -I/root/.phpenv/versions/8.5snapshot/include/php/ext -I/root/.phpenv/versions/8.5snapshot/include/php/ext/date/lib
LDFLAGS =
LIBTOOL = $(SHELL) $(top_builddir)/libtool
SHELL = /bin/bash
INSTALL_HEADERS =
BUILD_CC = cc
phplibdir = /workspace/modules
...
-include enc.dep
enc.lo: /workspace/enc.c
	$(LIBTOOL) --tag=CC --mode=compile $(CC) -I. -I/workspace $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS)   -DZEND_COMPILE_DL_EXT=1 -c /workspace/enc.c -o enc.lo  -MMD -MF enc.dep -MT enc.lo
$(phplibdir)/enc.la: ./enc.la
	$(LIBTOOL) --tag=CC --mode=install cp ./enc.la $(phplibdir)

./enc.la: $(shared_objects_enc) $(ENC_SHARED_DEPENDENCIES)
	$(LIBTOOL) --tag=CC --mode=link $(CC) -shared $(COMMON_FLAGS) $(CFLAGS_CLEAN) $(EXTRA_CFLAGS) $(LDFLAGS)  -o $@ -export-dynamic -avoid-version -prefer-pic -module -rpath $(phplibdir) $(EXTRA_LDFLAGS) $(shared_objects_enc) $(ENC_SHARED_LIBADD)
